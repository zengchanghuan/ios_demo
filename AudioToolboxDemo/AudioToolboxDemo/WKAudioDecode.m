...
- (instancetype)initWithConfig:(WKAudioConfig *)config {
    ...
    if(self){
        ...
        _config = config;
        if (_config == nil) {
            _config = [[WKAudioConfig alloc] init];
        }
...
- (void)setupEncoder {
    ...
    inputAduioDes.mFormatID = kAudioFormatMPEGLayer3;
